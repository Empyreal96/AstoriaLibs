...
namespace Microsoft.Arcadia.Marketplace.Decoder.Portable.Manifest.XmlAttributeValues
{
	internal static class XmlResourceIdMap
	{
		private static readonly Dictionary<string, string> ResourcesMap = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
	{
		{ "0x01010000", "theme" },
		{ "0x01010001", "label" },
		{ "0x01010002", "icon" },
		...
		{ "0x0101045e", "searchKeyphraseId" },
		{ "0x0101045f", "searchKeyphrase" },
		{ "0x01010460", "searchKeyphraseSupportedLocales" },
		...
		{ "0x010104a6", "searchKeyphraseRecognitionFlags" },
		...
		public static string MapXmlAttributeResourceId(string resourceId)
		{
			string value = null;
			ResourcesMap.TryGetValue(resourceId, out value);
